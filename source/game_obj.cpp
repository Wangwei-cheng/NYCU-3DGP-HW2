...
//Alive
bool GAME_OBJ::update(const Ogre::FrameEvent& evt)
{
    return true;
}
...
void GAME_OBJ::setDegreeCorrection( double degreeCorrection )
{
    mDegreeCorrection = degreeCorrection;
}
